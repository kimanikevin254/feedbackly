...
INSERT INTO "new_Feedback" ("createdAt", "email", "feedbackId", "message", "name", "updatedAt", "websiteId") SELECT "createdAt", "email", "feedbackId", "message", "name", "updatedAt", "websiteId" FROM "Feedback";
DROP TABLE "Feedback";
